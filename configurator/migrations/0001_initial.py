# Generated by Django 3.1.4 on 2021-01-23 22:49
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('device_id', models.ManyToManyField(to='configurator.Device', verbose_name='Schwachstelle bei folgenden Geräten ausnutzbar:')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('device_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='configurator.device')),
            ],
        ),
        migrations.CreateModel(
            name='Firmware',
            fields=[
                ...
                ('releasedate', models.DateField(verbose_name='Erscheinungsdatum')),
                ('Compatibility_list', models.ManyToManyField(to='configurator.Device', verbose_name='Firmware Kompatibel mit')),
            ],
            options={
